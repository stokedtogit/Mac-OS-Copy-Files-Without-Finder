...
After you unzip the file, you will need to tell Mac OS to not quarantine it. To do this, open terminal and enter "xattr -d com.apple.quarantine " and then drag the unzipped file into the terminal window. Hit enter and you will be able to run the file. 
